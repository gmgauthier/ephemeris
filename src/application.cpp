...
{
  return Glib::build_filename(runtime_dir(), "ephemeris.lock");
}

std::string socket_path()
{
  return Glib::build_filename(runtime_dir(), "ephemeris.sock");
}
...
void Application::present_windows()
{
...
void Application::on_activate()
{
  ...
  if (!lock_ok_) {
    if (!send_present())
      std::cerr << "ephemeris: already running\n";
    quit();
    return;
  }
